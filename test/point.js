...
var QuadTree = require('../prototypes/quadtree');
...
var test = describe('point', function () {
  ...
  it('Point with x should be lower than the width of the quadtree', function () {
    expect(pointTest.getX()).to.be.lower(quadtreeTest.getWidth());
  });
});
module.exports = test;
